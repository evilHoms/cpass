...
class ArgParser:
    ...
    def __init__(self):        
        ...
        parser.add_argument("mode", type=str, help="add - add new record/rm - remove by full name/ls - show list/find - find by part of name/gen - generate pass without adding to base/frm - find by part of name and remove after confirm/config - config external services.")
